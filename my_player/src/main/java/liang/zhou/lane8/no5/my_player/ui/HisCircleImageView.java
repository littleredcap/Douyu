 ...
 * 创建时间： 2018/4/17 0017
 */
public class HisCircleImageView extends AppCompatImageView {
    private float width;
    ...
    public HisCircleImageView(Context context) {
        this(context, null);
    }

    public HisCircleImageView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HisCircleImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
